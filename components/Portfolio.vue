<template>
  <div class="section card animated slideInLeft">
    <div class="content">
      <h3 class="title has-text-weight-light has-text-centered">
        There are more
      ...
      <div class="columns is-multiline is-vcentered">
        ...
        >
          ...
          >
          <a
            href="https://github.com/CHanson92/Project-1-Aloha-Homepage"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          >
          <a
            href="https://github.com/CHanson92/Project-2-Instanews"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          <p>HTML, CSS, SASS, JavaScript, jQuery</p>
          <a
            href="https://chanson92.github.io/Project-3-Beer-API/build/index"
            class="button"
            target="_blank"
            >Website</a
          >
          <a
            href="https://github.com/CHanson92/Project-3-Beer-API"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          <p>React.js, Meteor.js, MongoDB, SASS</p>
          <a href="https://fmma.herokuapp.com/" class="button" target="_blank"
            >Website</a
          >
          <a
            href="https://github.com/CHanson92/FMMA-Project-2"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          <p>React Native</p>
          <a
            href="https://github.com/CHanson92/Bakesale"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          <p>Vue.js, Bootstrap</p>
          <a
            href="https://github.com/CHanson92/Vue-Clothing-Store"
            class="button"
            target="_blank"
          >
            <img
        ...
        >
          ...
          <p>WordPress, PHP, JavaScript, jQuery, SASS</p>
          <a
            href="https://buzz.ldn.cp.academy.red"
            class="button"
            target="_blank"
            >Website</a
          >
          <a
            href="https://github.com/redacademy/tatteo-fall-2018"
            class="button"
            target="_blank"
          >
            <img
